import { context, type Scrollable, scrollCommands } from "@prs/keymap"
...
export const detailViewKeymap = Detail(
	...
	{ id: "detail.brief", title: "Open agent review brief", keys: ["v"], run: (s) => s.openBrief() },
